  ...
  const projects = [
    {
      ...
      image: "https://via.placeholder.com/400x250/1e40af/ffffff?text=E-Commerce",
    ...
    },
    {
      ...
      description: "A responsive weather dashboard with location-based forecasts, interactive maps, and detailed meteorological data.",
    ...
    },
    {
      ...
      description: "Analytics dashboard for social media metrics with data visualization, reporting, and export functionality.",
      technologies: ["React", "D3.js", "Express", "PostgreSQL"],
      image: "https://via.placeholder.com/400x250/7c3aed/ffffff?text=Analytics",
      liveUrl: "https://example.com",
      githubUrl: "https://github.com"
    },
    {
    ...
    },
    {
      ...
      description: "A feature-rich chat application with real-time messaging, file sharing, and end-to-end encryption.",
      technologies: ["Socket.io", "React", "Node.js", "JWT"],
      image: "https://via.placeholder.com/400x250/ea580c/ffffff?text=Chat+App",
      liveUrl: "https://example.com",
      githubUrl: "https://github.com"
    }
  ]
